...
GAME_FONT = pygame.freetype.Font("animo.ttf", 17)
GAME_FONT1 = pygame.freetype.Font("animo.ttf", 17)
GAME_FONT2 = pygame.freetype.Font("animo.ttf", 17)
...
start_button=Button(150,200,start_img,0.5)
exit_button=Button(160,300,exit_img,0.5)
